          ...
          <div class="col-12">
              <div class="card border border-secondary">
                  <div class="card-header bg-info">
                      <?php echo form_open('backend/laporan-pembelian'); ?>
                          <div class="row">
                      ...
                      <div class="card-body">
                        ...
                        <div class="table table-responsive">
                          <?php if(isset($submit)){ ?>
                            ...
                            <a href="<?= base_url("backend/export-laporan-pembelian/$tgl_awal/$tgl_akhir"); ?>" target="_blank" class="btn bg-navy btn-sm mb-2"><i class="fa fa-file-excel"></i> EXPORT DATA EXCEL</a>
                            <a href="<?= base_url("backend/cetak-laporan-pembelian-pdf/$tgl_awal/$tgl_akhir"); ?>" target="_blank" class="btn bg-primary btn-sm mb-2"><i class="fa fa-print"></i> CETAK PDF</a>
                            <a href="<?= base_url("backend/cetak-laporan-pembelian/$tgl_awal/$tgl_akhir"); ?>" target="_blank" class="btn bg-purple btn-sm mb-2"><i class="fa fa-print"></i> CETAK</a>
                          <?php } ?>
                          <table class="table table-bordered table-striped table-sm">
                            ...
                            if(isset($submit))
                            {
                              if($data->num_rows() > 0 AND $data->num_rows() <= 1000)
                              {
                                  $no = 1;
                                  ...
                                  echo'<tr>
                                        ...
                                        <td>'.$r->jml_masuk.' '.$r->satuan.'</td>
                                      </tr>';
                                  endforeach;
                              }elseif($data->num_rows() > 1000)
                              {
                                echo'<tr>
                                      <td colspan="6" class="text-center text-danger text-bold">
                                        ...
                                        <a href="'.base_url("backend/cetak-laporan-pembelian-pdf/$tgl_awal/$tgl_akhir").'" target="_blank" class="btn bg-primary btn-flat btn-xs mb-2"><i class="fa fa-print"></i> CETAK PDF</a>
                                        <a href="'.base_url("backend/cetak-laporan-pembelian/$tgl_awal/$tgl_akhir").'" target="_blank" class="btn bg-purple btn-flat btn-xs mb-2"><i class="fa fa-print"></i> CETAK</a>
                                      </td>
                                    </tr>';
                              }else
                              {
